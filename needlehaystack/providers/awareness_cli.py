...
class AwarenessCLI(ModelProvider):
    ...
    # TODO: figure out if we need to pass along any other config args to AwarenessCLI
    ...
    async def evaluate_model(self, prompt: str) -> str:
        ...
        """
        # TODO: call into AwarenessCLI with prompt, any config args, and receive a response. OpenAI call examples:
        # prompt: see below (generate_prompt())
        # model_kwargs: see __init__() above (dict(max_tokens  = 300, temperature = 0))
        ...
        # TODO: parse the response. OpenAI call examples:
        # response: ChatCompletion(id='chatcmpl-9Yh0qqvZYUBgU4Z2HbHIQ1BVvMLqE', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='The best thing to do in San Francisco is eat a sandwich and sit in Dolores Park on a sunny day.', role='assistant', function_call=None, tool_calls=None))], created=1718055520, model='gpt-4o-2024-05-13', object='chat.completion', system_fingerprint='fp_319be4768e', usage=CompletionUsage(completion_tokens=22, prompt_tokens=854, total_tokens=876))
        # response.choices[0].message.content: 'The best thing to do in San Francisco is eat a sandwich and sit in Dolores Park on a sunny day.'
